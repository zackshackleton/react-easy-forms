...
var CheckGroup = function (_Component) {
  ...
  _createClass(CheckGroup, [{
    ...
    value: function render() {
      var newCheckClass = (0, _classHelper.classHelper)('CheckGroup refInput ' + this.props.className, [['refInput-field--noTitle', !this.props.title]]);
...
var EmailInput = function (_Component) {
  ...
  _createClass(EmailInput, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'EmailInput refInput ' + this.props.className },
        this.props.title ? _react2.default.createElement(
          'label',
...
var Form = function (_Component) {
  ...
  _createClass(Form, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'form',
        { className: 'refForm ' + this.props.className, onSubmit: this.submitForm },
        this.props.title ? _react2.default.createElement(
          'div',
...
var PasswordInput = function (_Component) {
  ...
  _createClass(PasswordInput, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'PasswordInput refInput ' + this.props.className },
        this.props.title ? _react2.default.createElement(
          'label',
          { className: 'refInput-title', htmlFor: this.props.id },
          this.props.title
...
var PhoneInput = function (_Component) {
  ...
  _createClass(PhoneInput, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'PhoneInput refInput ' + this.props.className },
        this.props.title ? _react2.default.createElement(
          'label',
          { className: 'refInput-title', htmlFor: this.props.id },
          this.props.title
...
var RadioGroup = function (_Component) {
  ...
  _createClass(RadioGroup, [{
    ...
    key: 'render',
    value: function render() {
      var newRadioClass = (0, _classHelper.classHelper)('RadioGroup refInput ' + this.props.className, [['refInput-field--noTitle', !this.props.title]]);
...
var TextArea = function (_Component) {
  ...
  _createClass(TextArea, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'TextArea refInput ' + this.props.className },
        this.props.title ? _react2.default.createElement(
          'label',
          { className: 'refInput-title', htmlFor: this.props.id },
          this.props.title
...
var TextInput = function (_Component) {
  ...
  _createClass(TextInput, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'TextInput refInput ' + this.props.className },
        this.props.title && _react2.default.createElement(
          'label',
          { className: 'refInput-title', htmlFor: this.props.id },
          this.props.title
